...
type ClergyScreenNavigationProp = StackNavigationProp<RootStackParamList, 'Clergy'>;

interface Props {
  navigation: ClergyScreenNavigationProp;
}

const clergyFiles = [
  'Three Absolutions and Short Blessing',
...
export const ClergyScreen: React.FC<Props> = ({ navigation }) => {
  useLayoutEffect(() => {
    if (Platform.OS === 'web') {
